...
public enum BasicSecurityAlgorithm implements SecurityAlgorithm {
    ...
    AES192OFB("AES128OFB", "AES", "OFB", 192, true, 16),
    AES192CFB("AES128CFB", "AES", "CFB", 192, true, 16),
    AES192GCM("AES128GCM", "AES", "GCM", 192, true, 16),

    AES256ECB("AES256ECB", "AES", "ECB", 256, false, 0),
    AES256CBC("AES256CBC", "AES", "CBC", 256, true, 16),
    AES256CTR("AES256CTR", "AES", "CTR", 256, true, 16),
    AES256OFB("AES128OFB", "AES", "OFB", 256, true, 16),
    AES256CFB("AES128CFB", "AES", "CFB", 256, true, 16),
    AES256GCM("AES128GCM", "AES", "GCM", 256, true, 16),
