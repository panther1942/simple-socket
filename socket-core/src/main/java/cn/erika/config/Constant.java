...
public class Constant {
    ...
    public static final String DIGITAL_SIGNATURE_ALGORITHM = "signAlgorithm";
    public static final String DIGITAL_SIGNATURE = "sign";
    ...
    public static final String SRV_LS = "srv_list";
