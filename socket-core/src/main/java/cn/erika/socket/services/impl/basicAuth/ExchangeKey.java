...
public class ExchangeKey extends BaseService implements ISocketService {
    ...
    public void server(ISocket socket, Message message) {
        ...
        reply.add(Constant.PUBLIC_KEY, encoder.encode(GlobalSettings.publicKey));
        reply.add(Constant.DIGITAL_SIGNATURE_ALGORITHM, GlobalSettings.signAlgorithm.getValue());
