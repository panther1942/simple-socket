...
public class RSA {
     ...
     */
    public static byte[] encryptByPrivateKey(byte[] data, byte[] key) throws SecurityException {
        try {
     ...
     * @throws SecurityException 1、当前环境不支持该加密方法 2、秘钥无效 3、秘钥不匹配
     */
    public static byte[] encryptByPublicKey(byte[] data, byte[] key) throws SecurityException {
        try {
     ...
     * @throws SecurityException 1、当前环境不支持该加密方法 2、秘钥无效 3、秘钥不匹配
     */
    public static byte[] decryptByPublicKey(byte[] data, byte[] key) throws SecurityException {
        try {
            PublicKey publicKey = getPublicKey(key);
            Cipher cipher = Cipher.getInstance(publicKey.getAlgorithm());
